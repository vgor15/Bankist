...
const displayMovements = function (movements) {
  movements.forEach(function (val, index) {
    ...
    <div class="movements__row">
        <div class="movements__type movements__type--/* The `deposit` function is not defined in the
        provided code snippet. However, based on the
        context, it seems like you might be referring
        to the logic for determining whether a movement
